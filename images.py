...
my_img1 = ImageTk.PhotoImage(Image.open('images/Coffee.jpg'))
my_img2 = ImageTk.PhotoImage(Image.open('images/Coding.jpg'))
my_img3 = ImageTk.PhotoImage(Image.open('images/Energy.jpg'))
my_img4 = ImageTk.PhotoImage(Image.open('images/Focus.jpg'))
my_img5 = ImageTk.PhotoImage(Image.open('images/Study.jpg'))
